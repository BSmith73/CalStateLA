...
gameIcon = pygame.image.load('rocketIcon.png')
bg_image = pygame.image.load("starbg.jpg")
welcome_bg = pygame.image.load("welcome_bg.jpg")
...
def game_intro():
    ...
    while intro:
        ...
        gameDisplay.blit(welcome_bg, (0, 0))
        largeText = pygame.font.SysFont("comicsansms",115)
